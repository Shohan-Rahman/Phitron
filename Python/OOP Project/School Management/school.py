class School:
    ...
    def value_to_grade(value):
        if value == 5.00:
            return 'A+'
        elif value < 5.00 and value >= 4.00:
            return 'A'
        elif value < 4.00 and value >= 3.50:
            return 'A-'
        elif value < 3.50 and value >= 3.00:
            return 'B'
        elif value < 3.00 and value >= 2.00:
            return 'C'
        elif value < 2.00 and value >= 1.00:
            return 'D'
        else:
            return 'F'
